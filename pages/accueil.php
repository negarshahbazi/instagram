...
<section id="accueil">
    <div class="container vh-100">
        <div class="row">
            ...
            <div id="image-accueil" class="d-flex justify-content-end ">
                <input type="image" name="avatar" src="../images/Avatar-Profile-Vector-PNG-Pic.png" alt="" width="100" height="100" class="m-2 border rounded-pill">
            </div>
        </div>
    </div>
</section>

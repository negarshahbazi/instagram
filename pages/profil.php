...
<?php require_once('../partiel/header.php')?>
    ...
    <div class="container myHead" >
        <div class="row mt-2  d-flex justify-content-center align-items-center">
            <form action="../process/back_end.php" method="post" class="d-flex justify-content-center align-items-center">
                ...
                <div class="col-8">
                    <input type="text" name="pseudo" value=" <?php echo $_SESSION['user']['pseudo']?>">
                </div>
                <div class="col-2"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
    ...
    <section class="myPhotos">
        <div class="row d-flex justify-content-center align-items-center container">
            ...
            <?php foreach ($posts as $post){ ?>
                <li>
                    <div class="col-4"><img class="border-myImage" src="<?php echo "../images/" . $post['src_photo']?>" alt=""></div>
    ...
    <footer>
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-4"><a href="./post.php" class="btn btn-info">post</a></div>
            <div class="col-4"><button type="submit" name="search" class="btn btn-info">Search <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search-heart" viewBox="0 0 16 16">

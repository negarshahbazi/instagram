        ...
        <div class="row mt-2  d-flex justify-content-center align-items-center">
            <form action="../process/back_end.php" method="post" class="d-flex justify-content-center align-items-center ">
                <div class="col-2 d-flex flex-column align-items-center ">
                    ...
                    <button type="button" class="btn btn-info" data-toggle="modal" id="avatar" data-target="#avatarModal">Modifier</button>
        ...
        <div class="modal" id="photoModal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <!-- like -->
                    <div><button type="submit" name="like"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-heart m-3 like" viewBox="0 0 16 16">
